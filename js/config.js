...
/* @tweakable Show private projects by default when viewing *another* user's profile (requires showOtherUsersPrivateProjects to be true AND API permission) */
...
/* @tweakable Allow attempting to view private projects on other users' profiles (requires API permission) */
...
/* @tweakable Private toggle button text when private projects are currently shown */
const privateToggleShownText = "Show Public Only";
/* @tweakable Private toggle button text when private projects are currently hidden */
